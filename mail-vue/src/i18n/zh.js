const zh = {
    ...
    emailPush: '邮件推送',
    emailWebhook: '邮件 Webhook',
    emailWebhookDesc: '收到邮件后按收件人和发件人规则推送到外部程序',
    emailWebhookUrl: 'Webhook 地址',
    emailWebhookSecretDesc: 'Webhook 密钥（留空保持现有密钥）',
    emailWebhookToLikeDesc: "收件人规则，例如 %{'@'}example.com",
    emailWebhookSendLikeDesc: "发件人规则，例如 %{'@'}%.%.example.org",
    emailWebhookIncomplete: '启用前请填写完整的地址、密钥和匹配规则',
    tgBot: 'Telegram 机器人',
    disable: '关闭',
    disabled: '已关闭',
    otherEmail: '第三方邮箱',
