const en = {
    ...
    emailWebhookDesc: 'Push received emails to an external service by recipient and sender rules',
    emailWebhookUrl: 'Webhook URL',
    emailWebhookSecretDesc: 'Webhook secret (leave empty to keep the current secret)',
    emailWebhookToLikeDesc: "Recipient rule, for example %{'@'}example.com",
    emailWebhookSendLikeDesc: "Sender rule, for example %{'@'}%.%.example.org",
    emailWebhookIncomplete: 'Enter the URL, secret, and matching rules before enabling',
    tgBot: 'Telegram Bot',
    disable: 'Disable',
    disabled: 'Disabled',
